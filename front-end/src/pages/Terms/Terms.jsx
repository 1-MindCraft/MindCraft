    ...
    <div className="terms-page">
      ...
      <header className="terms-header">
        <div className="terms-header-logo">
          <img src={LOGO_SRC} alt="" className="terms-logo-img" />
          <span className="terms-logo-text">MIND <span>CRAFT</span></span>
        </div>
        <button className="terms-close-btn" onClick={() => window.close()}>
          닫기 ✕
        </button>
      </header>
      ...
      <main className="terms-body">
        <h1 className="terms-title">마인드크래프트 서비스 이용약관</h1>
        ...
        <section className="terms-section terms-appendix">
          <h2>부칙</h2>
